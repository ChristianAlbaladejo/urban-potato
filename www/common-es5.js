                ...
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    ...
                    case 2:
                      ...
                      return _context3.abrupt("return", this._http.get('https://clouddemosjnc.dyndns.org:5001/DescargaDocumento/ObtenerImagenes?imagenes=79', {
                        headers: headers
                      }));
                ...
                while (1) {
                  switch (_context4.prev = _context4.next) {
                    ...
                    case 2:
                      ...
                      return _context4.abrupt("return", this._http.get('https://clouddemosjnc.dyndns.org:5001/consulta/articulo?campos=TOP (15) ARTALIAS ,CODART,ID ,DESCART ,PRCCOMPRA', {
                        headers: headers
                      }));
                ...
                while (1) {
                  switch (_context5.prev = _context5.next) {
                    ...
                    case 5:
                      ...
                      return _context5.abrupt("return", this._http.get('https//clouddemosjnc.dyndns.org:5001/consulta/cabefacv?filtar=codcli=' + user.value, {
                        headers: headers
                      }));
                ...
                while (1) {
                  switch (_context6.prev = _context6.next) {
                    ...
                    case 2:
                      ...
                      return _context6.abrupt("return", this._http.get('https://clouddemosjnc.dyndns.org:5001/DescargaDocumento/LSTIMPRALBV/drive?parametros=identificador=' + id, {
                        headers: headers
                      }));
                ...
                while (1) {
                  switch (_context7.prev = _context7.next) {
                    ...
                    case 2:
                      ...
                      console.log(body);
                      return _context7.abrupt("return", this._http.post('https://clouddemosjnc.dyndns.org:5001/pedido', body, {
                        headers: headers
                      }));
                ...
                while (1) {
                  switch (_context8.prev = _context8.next) {
                    ...
                    case 2:
                      ...
                      return _context8.abrupt("return", token.value);
