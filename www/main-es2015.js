...
/* harmony import */ var _guards_auto_login_guard__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./guards/auto-login.guard */ "./src/app/guards/auto-login.guard.ts");
...
const routes = [
    ...
    {
        path: 'facturas',
        loadChildren: () => Promise.all(/*! import() | facturas-facturas-module */[__webpack_require__.e("common"), __webpack_require__.e("facturas-facturas-module")]).then(__webpack_require__.bind(null, /*! ./facturas/facturas.module */ "./src/app/facturas/facturas.module.ts")).then(m => m.FacturasPageModule),
        canLoad: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'visitas',
        loadChildren: () => __webpack_require__.e(/*! import() | visitas-visitas-module */ "visitas-visitas-module").then(__webpack_require__.bind(null, /*! ./visitas/visitas.module */ "./src/app/visitas/visitas.module.ts")).then(m => m.VisitasPageModule),
        canLoad: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'cart',
...
const { PushNotifications } = _capacitor_core__WEBPACK_IMPORTED_MODULE_8__["Plugins"];
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, authService, router, fcmService) {
...
const environment = {
    production: false,
    apiUrl: "http://clouddemosjnc.dyndns.org:5001/"
};
/*
...
module.exports = __webpack_require__(/*! C:\Users\Christian\Documents\higiesmurApp\src\main.ts */"./src/main.ts");
